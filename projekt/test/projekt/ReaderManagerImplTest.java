...
public class ReaderManagerImplTest {
    ...
    public void testEditReader(){
        ...
        manager.editReader(reader);        
        assertEquals("Reader's phone number isn't same after edit", new Integer(987654321), reader.getPhone());
        
        reader = manager.findReaderById(readerId);
        reader.setPhoneNumber(null);
        manager.editReader(reader);
        assertNull("Reader's phone number isn't null after edit", reader.getPhone());
    ...
    public void testFindAllReaders(){
        ...
        assertNull("Someone is in database!", manager.findAllReaders());
